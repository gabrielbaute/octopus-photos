...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1316: x0 => x0.click(),
      _1317: x0 => new Blob(x0),
      _1320: (x0,x1) => x0.removeItem(x1),
      _1322: (x0,x1) => x0.getItem(x1),
      _1323: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1324: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1325: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1326: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1327: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1328: (x0,x1,x2) => x0.setItem(x1,x2),
      _1329: (x0,x1) => x0.getRandomValues(x1),
      _1330: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1331: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1332: Date.now,
      ...
      _1552: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1553: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1562: (x0,x1,x2) => x0.open(x1,x2),
      _1563: x0 => x0.abort(),
      _1564: x0 => x0.getAllResponseHeaders(),
      ...
      _3845: x0 => x0.isSecureContext,
      _3848: x0 => x0.crypto,
      _3853: x0 => x0.sessionStorage,
      _3854: x0 => x0.localStorage,
      _3864: x0 => x0.origin,
      _3980: x0 => x0.vendor,
      _6091: x0 => x0.type,
      _6194: x0 => x0.firstChild,
      _6205: () => globalThis.document,
