...
class StorageController(BaseController):
    ...
    def create_initial_storage(self, user_id: str, path: str) -> Optional[UserStorage]:
        """
        Crea el registro inicial de almacenamiento para un usuario nuevo.

        Args:
            user_id (str): ID del usuario del almacenamiento.
    ...
    def update_usage(self, user_id: str, size_delta: int, files_delta: int = 1) -> bool:
        """
        ...
        if storage_db:
            ...
            return self._update_or_rollback(storage_db)
        return False